import type { IDatabaseDriver } from "../entities/db2.js";


export class PostgreSqlDriver implements IDatabaseDriver {
    connect(): Promise<void> {
        console.log("[SIMULATING]: Connecting to PostgreSQL database...");
        return Promise.resolve();
    }
    disconnect(): Promise<void> {
        console.log("[SIMULATING]: Disconnecting from PostgreSQL database...");
        return Promise.resolve();
    }
